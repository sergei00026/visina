(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".main__slider", {
            ...
            new swiper_core_Swiper(".documents__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            new swiper_core_Swiper(".recommendations__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            new swiper_core_Swiper(".objects__swiper", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
            ...
            new swiper_core_Swiper(".principlesNew__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                autoHeight: true,
